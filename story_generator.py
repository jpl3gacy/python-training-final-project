...
#     elif int(age) in range(4, 11):
#         return "still in elementary school" 
#     elif int(age) in range(11, 14):
#         return "still in middle school "
#     elif int(age) in range(14, 19):
#         return "still in high school"
#     elif int(age) in range(19, 24):
#         return "probably in college"
#     elif int(age) in range(24, 40):
#         return "a young adult"
#     elif int(age) in range(40, 56):
#         return "going through a mid-life crisis"
#     elif int(age) in range(56, 100):
#         return " a senior citizen"
#     elif int(age) > 100:
#         return "Extremly old. How are even still alive?"
#     else:
#         return age + " years old"


# def feeling_story(pronoun, feeling):
#     if feeling.capitalize() == "Happy":
#         return pronoun + " probably feels like jumping on fluffy clouds"
#     elif feeling.capitalize() == "Sad":
#         return pronoun + " probably feels like the world is tearing them apart"
#     elif feeling.capitalize() == "Bored":
#         return pronoun + " probably feels like there is nothing to do"
#     else:
#         return pronoun + " feels like ..."
...
# print("Out of these feelings which one relates to you the most? \n Happy, Sad, or Bored ")
# feeling = input("How are you feeling? (adj.): ")

# print(name_pronoun + " is " + age_story(age) + ". " + feeling_story(pronoun, feeling))
